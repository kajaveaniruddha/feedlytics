...
export const workspaceSidebarNavEntries: WorkspaceSidebarNavEntry[] = [
  ...
  },
  {
    ...
    resolveHref: ({ workspacePublicId }) => routes.workspaceFeedbacks(workspacePublicId),
    resolveActive: (pathname, ctx) => pathname === routes.workspaceFeedbacks(ctx.workspacePublicId),
  },
  {
    id: "widget",
    label: "Widget",
  ...
  },
  {
    ...
    label: "Team",
    icon: UsersIcon,
    resolveHref: ({ workspacePublicId }) => routes.workspaceTeam(workspacePublicId),
    resolveActive: (pathname, ctx) => pathname === routes.workspaceTeam(ctx.workspacePublicId),
  },
  {
    id: "billing",
    label: "Billing",
    icon: CreditCardIcon,
    resolveHref: ({ workspacePublicId }) => routes.workspaceBilling(workspacePublicId),
    resolveActive: (pathname, ctx) => pathname === routes.workspaceBilling(ctx.workspacePublicId),
  },
  {
    id: "settings",
    label: "Settings",
