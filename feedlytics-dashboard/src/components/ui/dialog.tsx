...
/** Left edge panel (mobile sidebar). Uses same portal/overlay as DialogContent. */
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "fixed top-0 left-0 z-50 flex h-[100dvh] w-[min(100vw,280px)] flex-col overflow-hidden rounded-none bg-surface shadow-card ring-0 outline-none duration-200 data-open:animate-in data-open:slide-in-from-left data-closed:animate-out data-closed:slide-out-to-left dark:bg-navy-800 dark:shadow-none",
          className
        )}
        {...props}
      >
